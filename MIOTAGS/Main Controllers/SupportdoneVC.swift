...
class SupportdoneVC: UIViewController {
    ...
    func layout(){
        ...
        mytitle.anchorWith_TopLeftBottomRight_Padd(top: view.safeAreaLayoutGuide.topAnchor, left: nil, bottom: msgimg.topAnchor, right: nil,padd: .init(top: 50, left: 0, bottom: 0, right: 0))
