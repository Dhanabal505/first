//
//  ErrorSupportVC.swift
//  MIOTAGS
//
//  Created by Dhanabal on 23/02/20.
//  Copyright © 2020 Dhanabal. All rights reserved.
//

import UIKit

class ErrorSupportVC: UIViewController  {
    ...
    @objc func sendact(){
        ...
        let sendbtn = storyboard?.instantiateViewController(withIdentifier: "ESupportDoneVC") as! ESupportDoneVC
